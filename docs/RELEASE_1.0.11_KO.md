...
> 이 문서는 최초 1.0.11 작업 당시의 기록입니다. 아래의 수동 태그 push 요구는 후속 수정으로 해소되었습니다. 현재 사용법과 이번 작업의 검증 결과는 [태그 누락 수정 안내](RELEASE_1.0.11_TAG_FIX_KO.md)를 확인하세요. 아래 Windows 검사·빌드 기록은 이번 수정에서 재실행한 결과가 아닙니다.
